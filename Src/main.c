...
#define BUTTON_B2_EXTI_PortSourceGPIOx	EXTI_PortSourceGPIOB
...
#define BUTTON_B2_EXTITrigger_TypeDef  	EXTI_Trigger_Rising_Falling
...
#define BUTTON_B3_EXTI_PortSourceGPIOx	EXTI_PortSourceGPIOA
...
#define BUTTON_B3_EXTITrigger_TypeDef  	EXTI_Trigger_Rising_Falling
...
#define BUTTON_B4_EXTI_PortSourceGPIOx	EXTI_PortSourceGPIOB
...
#define BUTTON_B4_EXTITrigger_TypeDef  	EXTI_Trigger_Rising_Falling
...
void Button_Init(void)
{
	...
	Input_Interrupt(BUTTON_B2_Init_SetClock, BUTTON_B2_GPIO_PIN, BUTTON_B2_GPIO_PORT, BUTTON_B2_EXTI_PortSourceGPIOx, BUTTON_B2_EXTI_PinSourcex, BUTTON_B2_EXTI_Line, BUTTON_B2_NVIC_IRQChannel,BUTTON_B2_EXTITrigger_TypeDef);
	Input_Interrupt(BUTTON_B3_Init_SetClock, BUTTON_B3_GPIO_PIN, BUTTON_B3_GPIO_PORT, BUTTON_B3_EXTI_PortSourceGPIOx, BUTTON_B3_EXTI_PinSourcex, BUTTON_B3_EXTI_Line, BUTTON_B3_NVIC_IRQChannel,BUTTON_B3_EXTITrigger_TypeDef);
	Input_Interrupt(BUTTON_B4_Init_SetClock, BUTTON_B4_GPIO_PIN, BUTTON_B4_GPIO_PORT, BUTTON_B4_EXTI_PortSourceGPIOx, BUTTON_B4_EXTI_PinSourcex, BUTTON_B4_EXTI_Line, BUTTON_B4_NVIC_IRQChannel,BUTTON_B4_EXTITrigger_TypeDef);
}
/**
